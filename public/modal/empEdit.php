<div class="modal fade bd-example-modal-lg" data-backdrop="static" id="ModalEditarEmp" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body p-5">
        <form action="" id="formUpdateEmp" name="formUpdateEmp">
      ...
      <div class="modal-footer">
        <button id="updateEmp" type="button" class="btn btn-warning-melody"><i class="fas fa-edit"></i> Editar</button>
