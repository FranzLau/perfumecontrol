...
<div class="container-fluid">
  <div class="modal fade bd-example-modal-lg" data-backdrop="static" id="ModalNuevoEmp" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content p-3">
            ...
            <div class="row">
              ...
              <div class="col-md-5"><!--<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<-->
                <div class="row form-group">
                  ...
                  <div class="col-md-8">
                    <select name="estaemp" id="estaemp" class="form-control form-control-sm">
                      <option selected style="display:none">Elije una...</option>
        ...
        <div class="modal-footer">
          <button id="createEmp" type="button" class="btn btn-success-melody"><i class="fas fa-save mr-2"></i> Guardar</button>
